...
| Description: Definition of the PegasusSimulator class (a singleton) that is used to manage the Pegasus framework.
"""
...
from pegasus.simulator.params import DEFAULT_WORLD_SETTINGS, SIMULATION_ENVIRONMENTS
from pegasus.simulator.logic.vehicles import VehicleManager


class PegasusSimulator:
    """
    PegasusSimulator is a singleton class (there is only one object instance at any given time) that will be used
    to 
    """
    ...
    def __new__(cls):
        """Allocates the memory and creates the actual PegasusSimulator object is not instance exists yet. Otherwise,
        returns the existing instance of the PegasusSimulator class.
